...
void main() {
  ...
  setUp(() {
    ...
    when(() => mockNotificationRepository.scheduleGoalReminders(any()))
        .thenAnswer((_) async => const Result.success(null));
    when(() => mockNotificationRepository.cancelGoalReminders(any()))
        .thenAnswer((_) async => const Result.success(null));
  ...
  group('Notification Reminder Integration QA Skill Tests', () {
    test('TC-P0-01 (Positive): AddGoalEvent saves goal and triggers scheduleGoalReminders', () async {
      ...
      verify(() => mockNotificationRepository.scheduleGoalReminders(goal)).called(1);
    });

    test('TC-C0-01 (Monkey/Chaos): DeleteGoalEvent deletes goal and triggers cancelGoalReminders', () async {
      ...
      verify(() => mockGoalRepository.deleteGoal('g_integration_1')).called(1);
      verify(() => mockNotificationRepository.cancelGoalReminders('g_integration_1')).called(1);
    });
  });
}
