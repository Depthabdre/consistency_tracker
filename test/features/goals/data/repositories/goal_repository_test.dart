...
void main() {
  ...
  group('getGoals', () {
    test('Positive: should return list of goals from local data source', () async {
    ...
    test('Negative: should return CacheFailure when datasource throws an exception', () async {
      when(() => mockLocalDataSource.getGoals())
  ...
  group('saveGoal', () {
    ...
    test('Negative: should return CacheFailure when save Goal throws error', () async {
      when(() => mockLocalDataSource.saveGoal(any()))
  ...
  group('deleteGoal', () {
    test('Positive: should delete goal from local data source', () async {
      when(() => mockLocalDataSource.deleteGoal('1'))
          .thenAnswer((_) async => true);
    ...
    test('Negative: should return CacheFailure when deleteGoal throws error', () async {
      when(() => mockLocalDataSource.deleteGoal('1'))
